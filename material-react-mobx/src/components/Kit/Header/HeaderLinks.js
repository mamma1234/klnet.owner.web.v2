        ...
        <CustomDropdown
          ...
          dropdownList={[
            <Link to="/svc/tracking" className={classes.dropdownLink}>
              <LineStyle className={classes.dropdownIcons} /> Tracking
            </Link>,
      ...
      <ListItem className={classes.listItem}>
        <CustomDropdown
          ...
          dropdownList={[
            ...
            >
              <Dns className={classes.dropdownIcons} /> FCL-Sea
            </Link>,
			<Link
              to="/svc/terminal"
              className={classes.dropdownLink}
              onClick={e => smoothScroll(e, "headers")}
            >
              <Dns className={classes.dropdownIcons} /> Terminal
            </Link>,
          ]}
        />
      </ListItem>
	  <ListItem className={classes.listItem}>
	   <Link to="/auth/login" className={classes.dropdownLink}>
              <Fingerprint className={classes.dropdownIcons} /> Login Page
       </Link>
	  </ListItem>
	  <ListItem className={classes.listItem}>
	   <Link to="/auth/register" className={classes.dropdownLink}>
