...
class Sidebar extends React.Component {
  ...
  createLinks = routes => {
    ...
    return routes.map((prop, key) => {
      if( prop.path !="/profile" && prop.path !="/setting" && prop.path !="/board") {
      if (prop.redirect) {
        return null;
      }
      if (prop.collapse) {
    ...
    return (
      <div ref={this.mainPanel}>
	    ...
	    <SidebarWrapper
              ...
              //user={user}
              headerLinks={<ServiceNavbarLinks rtlActive={rtlActive} onLoginPageOpen={onLoginPageOpen} isAuthenticated={isAuthenticated} {...rest}/>}
              links={links}
            />
            {image !== undefined ? (
              <div
