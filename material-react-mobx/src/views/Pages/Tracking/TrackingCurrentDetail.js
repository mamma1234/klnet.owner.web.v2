  ...
  render() {
    ...
    return [
      <TableRow  key={this.props.index}  onClick={this.toggleExpander}>
        ...
        <TableCell style={{padding:'5px',textAlignLast:'center'}}>{data[3]}</TableCell>
        <TableCell style={{padding:'5px',textAlignLast:'center'}}>{data[4]}</TableCell>
        <TableCell style={{padding:'5px',textAlignLast:'center'}}>{data[5]}</TableCell>
        <TableCell style={{padding:'5px',textAlignLast:'center'}}>{data[6]}</TableCell>
      </TableRow>,
      this.state.expanded && (
