...
/*  const handleClose = () => {
  ...
  useEffect(() => {
	  //console.log("blNo:"+blNo+"carrer:"+carrierCode);
	    axios.post("/loc/getCntrList",{ carriercode:props.carrierCode,blno: props.blNo, }).then(res => setSelectData(res.data))
  ...
  return (
        <Card>
        	<CardHeader color="info" stats icon style={{paddingBottom:'2px'}}>
        		...
        		<p className={classes.cardTitleBlack}>BL & BKG NO :{props.blNo}</p>
        	</CardHeader>
