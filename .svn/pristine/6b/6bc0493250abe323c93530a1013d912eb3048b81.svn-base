    ...
    <div className={classes.container}>
      <GridContainer justify="center">
        <GridItem xs={12} sm={1} md={4}>
          ...
          <Grid container>
            <Grid item xs={12} sm={6} style={{paddingRight:'2px'}}>
              <Button
                ...
                //target="_blank"
                fullWidth
              >&nbsp;&nbsp;<img src={KakaoIcon} alt="īī��SNS" width="40" height="40"></img>&nbsp;&nbsp;Kakao
              </Button>
            </Grid>
            <Grid item xs={12} sm={6}style={{paddingLeft:'2px'}}>
              <Button
                ...
                //target="_blank"
                >&nbsp;&nbsp;<img src={NaverIcon} alt="���̹�SNS" width="40" height="40"></img>&nbsp;&nbsp;Naver
               </Button>
            </Grid>
            <Grid item xs={12} sm={6}style={{paddingRight:'2px'}}>
               <Button
                  ...
                  //target="_blank"
                  fullWidth
                >&nbsp;&nbsp;<img src={FaceIcon} alt="���̽���SNS" width="40" height="40"></img>&nbsp;&nbsp;FaceBook
                </Button>
            </Grid>
            <Grid item xs={12} sm={6}style={{paddingLeft:'2px'}}>
              <Button
                ...
                //target="_blank"
              >&nbsp;&nbsp;<img src={GoogleIcon} alt="����SNS" width="40" height="40"></img>&nbsp;&nbsp;Google
              </Button>
            </Grid>
          </Grid>
