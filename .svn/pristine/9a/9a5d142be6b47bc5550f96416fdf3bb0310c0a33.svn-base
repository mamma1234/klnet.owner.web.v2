  ...
  render() {
    ...
    return [
      <TableRow  key={this.props.index} className={this.staterowStyle} style={{borderCollapse:'separate',borderSpacing:'2px 2px',paddingTop:'5px'}} >
        ...
        <TableCell style={{padding:'0px',textAlignLast:'center',borderBottomWidth:'3px'}}>{data.carrier_code !="" && data.carrier_code != "SNK" && data.carrier_code.length ==3?<img src={require("assets/img/carrier/"+data.carrier_code+".gif")} />:data.carrier_code}</TableCell>
